...
function __wbg_adapter_52(arg0, arg1, arg2) {
    try {
        ...
        wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hac4bd53416b27ad7(retptr, arg0, arg1, addHeapObject(arg2));
...
function __wbg_adapter_55(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h8165a9bd1f494336(arg0, arg1, addHeapObject(arg2));
}

function __wbg_adapter_60(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h67ed1579342cd3be(arg0, arg1, addHeapObject(arg2));
}
...
function __wbg_adapter_63(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__Fn__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc7f0d7f4232200e9(arg0, arg1, addHeapObject(arg2));
}

function __wbg_adapter_66(arg0, arg1) {
    wasm._dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h6db05a8ae7eedb60(arg0, arg1);
}
...
function __wbg_adapter_639(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__heecda686f0a1f7b6(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
/**
*/
export const RepoType = Object.freeze({
/**
...
/**
*/
export const Quantization = Object.freeze({ Q8_0:0,"0":"Q8_0",F16:1,"1":"F16",F32:2,"2":"F32", });

const ApiFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_api_free(ptr >>> 0));
/**
*/
export class Api {
    ...
    */
    get_with_progress(file_name, callback) {
        const ptr0 = passStringToWasm0(file_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.api_get_with_progress(this.__wbg_ptr, ptr0, len0, addHeapObject(callback));
    ...
    */
    get(file_name) {
        const ptr0 = passStringToWasm0(file_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.api_get(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
    * @param {string} file_name
    * @returns {Promise<any>}
    */
    fetch_gguf_header(file_name) {
        const ptr0 = passStringToWasm0(file_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.api_fetch_gguf_header(this.__wbg_ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
    * @param {string} file_name
    ...
    * @returns {Promise<Uint8Array>}
    */
    fetch_range(file_name, start, end) {
        const ptr0 = passStringToWasm0(file_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.api_fetch_range(this.__wbg_ptr, ptr0, len0, start, end);
        return takeObject(ret);
    }
}

const ApiBuilderFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_apibuilder_free(ptr >>> 0));
/**
*/
export class ApiBuilder {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(ApiBuilder.prototype);
        obj.__wbg_ptr = ptr;
        ApiBuilderFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ApiBuilderFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_apibuilder_free(ptr);
    }
    /**
    ...
    * @returns {ApiBuilder}
    */
    static from_hf(repo_id, ty) {
        const ptr0 = passStringToWasm0(repo_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.apibuilder_from_hf(ptr0, len0, ty);
        return ApiBuilder.__wrap(ret);
    }
    /**
    * @param {string} repo_id
    * @param {RepoType} ty
    ...
    */
    static endpoint(repo_id, ty) {
        ...
        try {
            ...
            const ptr0 = passStringToWasm0(repo_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.apibuilder_endpoint(retptr, ptr0, len0, ty);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred2_0 = r0;
            deferred2_1 = r1;
    ...
    * @returns {ApiBuilder}
    */
    static from_hf_with_revision(repo_id, revision) {
        const ptr0 = passStringToWasm0(repo_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(revision, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.apibuilder_from_hf_with_revision(ptr0, len0, ptr1, len1);
        return ApiBuilder.__wrap(ret);
    }
    /**
    ...
    */
    build() {
        const ret = wasm.apibuilder_build(this.__wbg_ptr);
        return Api.__wrap(ret);
    }
}

const DecodingOptionsFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_decodingoptions_free(ptr >>> 0));
/**
*/
export class DecodingOptions {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        DecodingOptionsFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_decodingoptions_free(ptr);
    }
}

const DecodingOptionsBuilderFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_decodingoptionsbuilder_free(ptr >>> 0));
/**
*/
export class DecodingOptionsBuilder {
    ...
    static __wrap(ptr) {
        ...
        obj.__wbg_ptr = ptr;
        DecodingOptionsBuilderFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        DecodingOptionsBuilderFinalization.unregister(this);
        return ptr;
    }
    ...
    */
    setSuppressTokens(suppress_tokens) {
        const ptr = this.__destroy_into_raw();
        const ptr0 = passArray32ToWasm0(suppress_tokens, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
...
export class Model {
    ...
    */
    static load(model, quantization, progress) {
        const ret = wasm.model_load(addHeapObject(model), quantization, addHeapObject(progress));
        return takeObject(ret);
    }
    /**
    ...
    */
    run(input) {
        const ret = wasm.model_run(this.__wbg_ptr, addHeapObject(input));
        return takeObject(ret);
    }
}

const ModelKeyFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_modelkey_free(ptr >>> 0));
/**
*/
export class ModelKey {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ModelKeyFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_modelkey_free(ptr);
    }
    /**
    * @param {string} repo_id
    * @param {string} model_id
    */
    constructor(repo_id, model_id) {
        const ptr0 = passStringToWasm0(repo_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(model_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.modelkey_new(ptr0, len0, ptr1, len1);
        this.__wbg_ptr = ret >>> 0;
        return this;
    }
    /**
    ...
    */
    get repo_id() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.modelkey_repo_id(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    get model_id() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.modelkey_model_id(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
...
const SegmentFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_segment_free(ptr >>> 0));
/**
*/
...
const StreamedSegmentFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_streamedsegment_free(ptr >>> 0));

export class StreamedSegment {

    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        StreamedSegmentFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_streamedsegment_free(ptr);
    }
    /**
    * @returns {number}
    */
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_model_new = function(arg0) {
    ...
    imports.wbg.__wbg_createIndex_da6487aa78602b31 = function() { return handleError(function (arg0, arg1, arg2, arg3) {
    ...
    imports.wbg.__wbindgen_closure_wrapper517 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 17, __wbg_adapter_52);
        return addHeapObject(ret);
    };
    imports.wbg.__wbindgen_closure_wrapper5241 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 2429, __wbg_adapter_55);
        return addHeapObject(ret);
    };
    ...
    imports.wbg.__wbindgen_closure_wrapper5954 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 2639, __wbg_adapter_60);
        return addHeapObject(ret);
    };
    imports.wbg.__wbindgen_closure_wrapper6076 = function(arg0, arg1, arg2) {
        const ret = makeClosure(arg0, arg1, 2683, __wbg_adapter_63);
        return addHeapObject(ret);
    };
    imports.wbg.__wbindgen_closure_wrapper6078 = function(arg0, arg1, arg2) {
        const ret = makeClosure(arg0, arg1, 2683, __wbg_adapter_66);
        return addHeapObject(ret);
    };
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('ratchet-web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
